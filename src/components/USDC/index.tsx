...
//       : BigInt(transferAmountParsed) > bigIntBalance
//       ? "Amount must not be greater than balance"
//       : shouldRelay && relayerFee && (BigInt)transferAmountParsed < BigInt(relayerFee)
//       ? "Amount must at least cover the relayer fee"
//       : shouldRelay &&
//         relayerFee &&
//         toNativeAmount &&
//         (BigInt)transferAmountParsed < BigInt(relayerFee) + BigInt(toNativeAmount)
