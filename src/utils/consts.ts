...
export type Cluster = "testnet" | "mainnet" | "devnet";
const urlParams = new URLSearchParams(window.location.search);
const paramCluster = urlParams.get("cluster");
export const CLUSTER: Cluster =
  paramCluster === "mainnet" ? "mainnet" : "testnet";
...
export const COVALENT_BSC = BSC_NETWORK_CHAIN_ID;
export const COVALENT_POLYGON = POLYGON_NETWORK_CHAIN_ID;
export const COVALENT_AVAX = AVAX_NETWORK_CHAIN_ID;
export const COVALENT_FANTOM = FANTOM_NETWORK_CHAIN_ID;
export const COVALENT_KLAYTN = null; // Covalent only support mainnet
export const COVALENT_CELO =  null;
export const COVALENT_NEON =  null;
export const COVALENT_ARBITRUM =
  ARBITRUM_NETWORK_CHAIN_ID;

export const COVALENT_MOONBEAM =
  MOONBEAM_NETWORK_CHAIN_ID; // Covalent only supports mainnet
